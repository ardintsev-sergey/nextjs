import { Button, Htag, Ptag, Tag } from '../components/index';

export default function Home(): JSX.Element {
  return (
    <>  
      <Htag tag='h2'> Твою ж мать</Htag>
      <Button appeareance='primary' arrow='right'>Кнопке</Button>
      <Button appeareance='ghost' arrow='right'>Еще Кнопке</Button>
